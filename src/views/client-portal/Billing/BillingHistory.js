...
import {postBillingHistory, postBillingInvoice, postBillingInvoiceDownload} from "../../../services/BilingService";
...
function BillingHistory() {
    ...
    useEffect(function () {
        ...
        postBillingHistory({limit: limit, page: page})
            .then(response => {
