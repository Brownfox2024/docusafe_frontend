...
function SettingUserGroup(props) {
        ...
        <>
            ...
            <div className="tab-pane active show bg_transparent" id="user" role="tabpanel" aria-labelledby="user-tab">
                ...
                <div className="nav nav-tabs pt-4" id="navtab" role="tablist">
                    <NavLink to={"/settings/users"} className="nav-link" id="users" type="button"
                             role="tab" end>Users</NavLink>
                    {isGroupTab === true && (
                        <NavLink to={"/settings/users/group"} className="nav-link active" id="group-tab" type="button"
            ...
            <ModifyGroup userList={userList} groupData={groupData} setGroupData={setGroupData} isCall={isCall}
                         setIsCall={setIsCall} setLoading={setLoading}/>

            <DeleteGroup groupData={groupData} setGroupData={setGroupData} isCall={isCall} setIsCall={setIsCall}
