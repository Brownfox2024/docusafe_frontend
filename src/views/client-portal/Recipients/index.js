...
import {getRecipientList, recipientDetail} from "../../../services/Recipients";
...
function Recipients() {
    ...
    }, [limit, search, page, isEffect, isLoad]);
    ...
    return (
        <>
                        ...
                        <div className="wrap_right flexWrap tab-content clearfix step_wizard_content">
                            ...
                            <div className="functional_icons mb-3 ms-2">
                                <div className="dropdown">
                                    <span className="functional_icon_ellipsis" id="dropdownMenuButtonIE"
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButtonIE">
                            ...
                            <ModifyRecipient data={data} isEffect={isEffect} setIsEffect={setIsEffect} setData={setData}
            ...
            <DeleteRecipient delId={delId} setDelId={setDelId} isEffect={isEffect} setIsEffect={setIsEffect}/>
        </>
    )
}
