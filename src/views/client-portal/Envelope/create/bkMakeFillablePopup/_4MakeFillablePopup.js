    ...
    if (signDocMode === 2) {
      ...
      if (objPlaceholders.length === 0) {
        ...
        for (let i = 0; i < objPlaceholders.length; i++) {
          ...
          let recipientFound = requestSign.find(
            (obj) => obj.value === requestRecipient.value
          );
  ...
  return (
    ...
    >
      ...
      >
              ...
              <div className="fillable-wrapper">
                ...
                >
                  <div id="canvasContainer">
                    <canvas id="canv" ref={canvasRef} style={{ border: "none" }} />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div
          className={`modal fade ${textInputModal ? "show" : ""}`}
          id="textInputModal"
          tabIndex="-1"
          role="dialog"
          aria-labelledby="textInputModalLabel"
          aria-hidden={!textInputModal}
        >
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="textInputModalLabel">
                  Add Text
                </h5>
                <button
                  onClick={() => setTextInputModal(false)}
                  type="button"
                  className="close"
                  data-dismiss="modal"
                  aria-label="Close"
        ...
        <div
          className={`modal fade ${recipientSelectModal ? "show" : ""}`}
          id="recipientSelectModal"
          tabIndex="-1"
          role="dialog"
          aria-labelledby="recipientSelectModalLabel"
          aria-hidden={!recipientSelectModal}
        >
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="recipientSelectModalLabel">
                  Recipients
                </h5>
                <button
                  onClick={() => setRecipientSelectModal(false)}
                  type="button"
                  className="close"
                  data-dismiss="modal"
                  aria-label="Close"
