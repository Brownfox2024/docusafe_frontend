...
function MakeFillablePopup({
  ...
  const [signerSelectedBackgroundColor, setSignerSelectedBackgroundColor] = useState("d1ecf1");
  //const [selectedRecipientObj, setSelectedRecipientObj] = useState(null);
    ...
    if(row !== undefined){
      ...
      for (let i = 0; i < formObj.recipient_List.length; i++) {
        recipients.push({
          ...
          image : generateOptionImage(bg[i], formObj.recipient_List[i]["first_name"]),
          color_code : bg[i]
        });
      }
  ...
  function generateOptionImage(background, name){
    ...
    return "https://ui-avatars.com/api/?name="+firstChar+"&background="+background+"&color=000&rounded=true&bold=true&uppercase=true&length=1";
  }
  ...
  */
  ...
  function signObject(
    ...
    var fillColor = "#d1ecf1";
    var signatureText = "Signature";
    if(requestRecipient !== ""){
      fillColor = "#" + requestRecipient.color_code;
      signatureText = signatureText+ " ("+getInitials(requestRecipient.label)+")";
    }

    var signText = new fabric.Text(signatureText, {
      fontSize: fontSize,
    ...
    var textWidth = signText.width;
    var textHeight = signText.height;
    
    // Adjust rectangle width and height based on text size
    var object = new fabric.Rect({
      fill: fillColor,
      width: textWidth + 65, // Add some padding if needed
      height: textHeight + 23, // Add some padding if needed
      radius: 2,
      objectCaching: false,
      stroke: fillColor,
      strokeWidth: 1,
    ...
    // Adjust top position of text to center vertically within the rectangle
    signText.set({
      top: (object.height - textHeight) / 2
    });
    ...
    // var object = new fabric.Rect({
    //   //fill: "#d1ecf1",
    //   fill: "#"+requestRecipient.color_code,
    //   width: widthObject,
    //   height: heightObject,
    //   radius: 2,
    //   objectCaching: false,
    //   stroke: "#"+requestRecipient.color_code,
    //   strokeWidth: 1,
    //   hasControls: false,
    // });
    ...
    // var originX = "left";
    // var originY = "center";
    // var textLeft = 15; //(0.5 * widthObject);
  ...
  const textBoxObject = (
    ...
    } else if (objId.indexOf("email") > -1) {
      textLabel = "Email Address";
    } else if (objId.indexOf("Initials") > -1) {
      textLabel = "Initials";
    }
    ...
    if(requestRecipient !== ""){
      fillColor = "#" + requestRecipient.color_code;
      textLabel = textLabel+ " ("+getInitials(requestRecipient.label)+")";
    }
    
    var textLabelObj = new fabric.Text(textLabel, {
      fontSize: fontSize,
      fontWeight: fontWeight,
      fontFamily: "Arial",
      fill: "#0c5460",
    ...
    // Calculate text width and height
    var textWidth = textLabelObj.width;
    var textHeight = textLabelObj.height;
    ...
    var groupObjects = [object, textLabelObj];
  ...
  */
  ...
  // Define custom option component to include images
  const Option = (props) => (
    <components.Option {...props} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
        <img
          src={props.data.image} // Assuming the image URL is provided in the option data
          alt={props.data.label} // Use label as alt text
          style={{ marginRight: "7px", width: "30px", height: "30px" }} // Adjust image styling as needed
        />
                ...
                <div className="col-md-12">
                  ...
                  <div>
                    ...
                    <div className=" rounded mb-4">
                      ...
                      >
                        <div className="d-flex align-items-center">
                          <div className="me-2 icon-box" style={{ background: "#"+signerSelectedBackgroundColor }}>
                      ...
                      <div
                        ...
                        data-placement="right"
                        title=""
                        data-bs-original-title="Initials"
                        data-bs-placement="right"
                      >
                        <div className="d-flex align-items-center">
                          <div className="me-2 icon-box" style={{ background: "#"+signerSelectedBackgroundColor }}>
                    ...
                    <div className=" rounded mb-4">
                      ...
                      <div
                        draggable
                        onDragStart={(e) => handleDragStart(e, "recipient-email-address")}
                        onDragEnd={handleDragStop}
                        className="sign-tool"
                        name="rectangle"
                        //onClick={() => addTextBoxPlaceholder("recipient-textbox")}
            ...
            <div className="col-md-2 right-side tools-wrapper">
              ...
              <div className="no-field-selection">
                <div className="d-flex flex-column align-items-center">
                  ...
                  {signDocMode === 1 ? (
                    <div>
                        <div className="main-title text-center"><span>No Field Selected</span></div>
                        <div className="sub-title text-center"><span>Select a field to make changes</span></div>
                    </div>
                  ) : (
                    <div>
                      <div className="main-title text-center"><span>No Signer Selected</span></div>
                      <div className="sub-title text-center"><span>Please choose the signer</span></div>
                    </div>
                  )}
                </div>
              </div>
