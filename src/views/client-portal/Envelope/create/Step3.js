                        ...
                        <div className="row shadow-lg border_radius mx-0" style={{ background: "#fff" }}>
                            ...
                            <div className="col-lg-2 pt-3 border_right">
                                <div className="nav nav-tabs flex-column" id="nav-tab" role="tablist">
                                    ...
                                    <button className="nav-link" id="sharedWithMe-tab" data-bs-toggle="tab" data-bs-target="#sharedWithMe" type="button" role="tab" aria-controls="sharedWithMe" aria-selected="false"><i className="fa fa-list-alt" aria-hidden="true"></i> Information Request 
                                    
                                    {(props.formObj.fill_forms.length > 0) &&
                                        <span className="ms-2"><span className="badge bg-warning text-dark">{props.formObj.fill_forms.length}</span></span>
                                    }</button>
