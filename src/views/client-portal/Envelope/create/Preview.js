...
function EnvelopePreview(props) {
    ...
    useEffect(function () {
        ...
        if (props.formObj.sign_documents) {
            totalDocuments = totalDocuments + props.formObj.sign_documents.length;
        }
                                                ...
                                                <div className="navbar_client">
                                                    <div
                                                        ...
                                                        <p className="total_data">Total
                                                            Documents {props.formObj.fill_forms.length > 0 && `& Information`} {totalDocs}</p>
                                            ...
                                            <section
                                                ...
                                                <div className="nav nav-tabs pt-4" id="nav-tab" role="tablist">
                                                    <button className="nav-link active" id="document-form"
                                                        ...
                                                        <i className="fa fa-drivers-license-o me-1"
                                                           aria-hidden="true"/>
                                                        Documents {props.formObj.fill_forms.length > 0 && ` & Information`}
                                                    </button>
                                                ...
                                                <div className="tab-content  px-2 py-2" id="nav-tabContent">
                                                    <div className="tab-pane fade active show" id="document-form-detail"
                                                        ...
                                                        <label
                                                            className="tab_label">{userDetail.full_name} {userDetail.company && ` from ` + userDetail.company}
                                                            requested you to upload
                                                            Documents{props.formObj.fill_forms.length > 0 && ` & Information.`}.</label>
                                                                                                ...
                                                                                                <div key={i}
                                                                                                    ...
                                                                                                    {question.type === 8 && (
                                                                                                        <div
                                                                                                            ...
                                                                                                            <DatePicker
                                                                                                                className="form-control"
                                                                                                                selected={showDate(question.select_options)}
                                                                    ...
                                                                    <>
                                                                        ...
                                                                        {props.formObj.sign_documents.map((item, index) =>
                                                                            <div key={index}
                                                                                 className="accordion-item background_grey_400">
                                                                                <h2 className="accordion-header "
                                                                                    id={`SignDocument-${index}`}>
                                                                                    <button
                                                                                        className="accordion-button background_grey_400"
                                                                                        type="button"
                                                                                        data-bs-toggle="collapse"
                                                                                        data-bs-target={`#Sign-document-${index}`}
                                                                                        aria-expanded="true"
                                                                                        aria-controls={`Sign-document-${index}`}>
                                                                                        {item.name}
                                                                                    </button>
                                                                                    <span className="bg_light_blue">Click to Sign</span>
                                                                                </h2>
                                                                                <div id={`Sign-document-${index}`}
                                                                                     className="accordion-collapse collapse "
                                                                                     aria-labelledby={`SignDocument-${index}`}
                                                                                     data-bs-parent="#accordionExample">
                                            ...
                                            <section
                                                ...
                                                <div className="nav nav-tabs pt-4" id="nav-tab" role="tablist">
                                                    <button className="nav-link active" id="document-form2"
                                                            ...
                                                            aria-selected="true">
                                                        <i className="fa fa-drivers-license-o me-1"
                                                           aria-hidden="true"/>Documents {props.formObj.fill_forms.length > 0 && `& Information`}
                                                    </button>
