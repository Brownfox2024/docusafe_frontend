...
import {addTemplate} from "../../../../services/CommonService";
import Utils from "../../../../utils";
import {templateFolderList} from "../../../../services/Templates";

function AddEnvelopeTemplate(props) {
    ...
    useEffect(function () {
        templateFolderList({is_all: 1, folder_id: 0})
            .then(response => {
...
export default AddEnvelopeTemplate;