...
import {
    getTemplateEnvelope, getTemplateUser,
    templateEnvelopeModify,
    templateFolderBreadcrumbs
} from "../../../../../services/Templates";
import {toast} from "react-toastify";
import Utils from "../../../../../utils";
import {getEnvelopeDocumentCheckStorage, getPreferenceData, postCloudList} from "../../../../../services/CommonService";
import {
    NAME_CONVENTION,
    OVERDUE_REMINDER,
    PASSWORD_LIST,
...
function ModifyTemplate(props) {
            ...
            .then(responseData => {
                ...
                if (id) {
                    if (props.type === 1) {
                        ...
                        templateFolderBreadcrumbs({uuid: id})
                            .then(response => {
    ...
    const handleTemplate = async (e) => {
        ...
        if (isCall === true) {
            templateEnvelopeModify(formData)
                .then(response => {
                    setLoading(false);
    ...
    return (
        <>
            ...
            <DocumentTemplate docData={docData} setDocData={setDocData} documentList={documentList}
                              setDocumentList={setDocumentList} setLoading={setLoading}/>

            <RequestFormTemplate formData={formData} setFormData={setFormData} requestFormList={requestFormList}
