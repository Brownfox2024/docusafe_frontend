...
import AdminClientEnvelopeUpgrade from "./partials/AdminClientEnvelopeUpgrade";
import AdminClientUseTemplate from "./AdminClientUseTemplate";

function AdminClientPortalHome() {
    ...
    function onEnvelopeStart(e) {
        e.preventDefault();
        navigate("/back-admin/client-portal/" + client + "/envelope");
    }
    ...
    return (
        <>
                ...
                <div className="container">
                    ...
                    <div className="row scratch_template">
                        <div className="col-lg-6">
                            <NavLink to={'/back-admin/client-portal/' + client + '/envelope'}>
                                    ...
                                    <div className="card_content">
                                        ...
                                        <div className=" start_now d-flex justify-content-end">
                                            <button onClick={handleUseTemplate} type="button" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-bs-original-title={Lang.home_use_template}
            ...
            <AdminClientUseTemplate isUseTemplate={isUseTemplate} setIsUseTemplate={setIsUseTemplate}/>
        </>
    );
}

export default AdminClientPortalHome;