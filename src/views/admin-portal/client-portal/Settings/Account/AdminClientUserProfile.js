...
import {COUNTRY_CODE, COUNTRY_ID, SALT} from "../../../../../configs/AppConfig";
import {toast} from "react-toastify";
import Utils from "../../../../../utils";
import validator from "validator";
import {encryptData} from "../../../../../utils/crypto";
import {adminRemoveUserImage, adminUpdateUserData, adminUploadUserFile} from "../../../../../services/AdminService";

const AdminClientUserProfile = (props) => {
    ...
    }, [props?.companyData, countryList, client]);
    ...
    const handleFile = (e) => {
        ...
        if (e.target.files.length > 0) {
            ...
            adminUploadUserFile(client, formData)
                .then(response => {
    ...
    const handleRemoveImage = (e) => {
        ...
        props.setLoading(true);
        adminRemoveUserImage({client_id: client})
            .then(response => {
                setUserImage('');
                let encryptedData = encryptData(response.data.data, SALT);
                localStorage.setItem(client, encryptedData);
...
export default AdminClientUserProfile;