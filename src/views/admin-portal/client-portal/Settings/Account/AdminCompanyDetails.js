...
import {
    adminRemoveCompanyImage,
    adminUpdateCompanyDetails,
    adminUploadCompanyFile
...
const AdminCompanyDetails = (props) => {
    ...
    const handleCompanyFile = (e) => {
        ...
        if (e.target.files.length > 0) {
            ...
            adminUploadCompanyFile(client, formData)
                .then(response => {
    ...
    const handleRemoveImage = (e) => {
        ...
        props.setLoading(true);
        adminRemoveCompanyImage({client_id: client})
            .then(response => {
                let cmpData = {...props.companyData};
