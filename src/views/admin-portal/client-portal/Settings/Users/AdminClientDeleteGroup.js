...
import {adminDestroyGroupPost} from "../../../../../services/AdminService";

function AdminClientDeleteGroup(props) {
    ...
    const onGroupDestroy = (e) => {
        ...
        adminDestroyGroupPost({client_id: client, id: props.groupData.id})
            .then(response => {
...
export default AdminClientDeleteGroup;