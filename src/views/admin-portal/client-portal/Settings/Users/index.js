...
import AdminClientModifyUser from "./AdminClientModifyUser";
import AdminClientDeleteUser from "./AdminClientDeleteUser";
import AdminClientViewUser from "./AdminClientViewUser";
import {adminGetUserList} from "../../../../../services/AdminService";

const lengths = Utils.tableShowLengths();

function AdminClientSettingUsers() {
    ...
    }, [limit, page, search, groupId, isCall, client]);
        ...
        <>
            ...
            <div className="tab-pane active show bg_transparent" id="user" role="tabpanel" aria-labelledby="user-tab">
                ...
                <div className="nav nav-tabs pt-4" id="navtab" role="tablist">
                    <NavLink to={"/back-admin/client-portal/" + client + "/settings/users"} className="nav-link active"
                             id="users" type="button" role="tab">Users</NavLink>
                    {isGroupTab === true && (
                        <NavLink to={"/back-admin/client-portal/" + client + "/settings/users/group"}
                                 className="nav-link" id="group-tab" type="button"
                ...
                <div className="tab-content account_accordiom" id="navContent"
                    ...
                    <div className="tab-pane  p-4 active" id="users-detail" role="tabpanel" aria-labelledby="users">
                        ...
                        <AdminClientModifyUser users={users} setUsers={setUsers} roleList={roleList}
                                               groupList={groupList} userRoleAccessRef={userRoleAccessRef}
                                               setLoading={setLoading} setIsCall={setIsCall} isCall={isCall}/>

                        <AdminClientDeleteUser users={users} setUsers={setUsers} setLoading={setLoading}
                                               setIsCall={setIsCall} isCall={isCall}/>

                        <AdminClientViewUser users={users} setUsers={setUsers}/>
                    </div>
                </div>
            </div>
...
export default AdminClientSettingUsers;