...
import {
    adminGetBillingPlanList, adminPostChangePlan,
    adminPostPurchaseBillingPlan,
    adminPostSmsBuy, adminPurchasePlanPromoCode
} from "../../../../services/AdminService";

let yearList = Utils.cardYearList();

function AdminClientPricingPlan() {
    ...
    useEffect(function () {
        if (isCall === true) {
            ...
            adminGetBillingPlanList({client_id: client, is_admin: 1})
                .then(response => {
    ...
    const handlePayNow = (e) => {
        ...
        adminPostPurchaseBillingPlan(obj)
            .then(response => {
                setLoading(false);
                toast.success(response.data.message);
                navigate('/back-admin/client-portal/' + client + '/billing');
            })
            .catch(err => {
                setLoading(false);
    ...
    const handlePromoCode = (e) => {
        ...
        adminPurchasePlanPromoCode(obj)
            .then(response => {
                setLoading(false);
                toast.success(response.data.message);
                navigate('/back-admin/client-portal/' + client + '/billing');
                    ...
                    <table className="table mb-0 table-striped shadow-sm price-plan-table"
                        ...
                        <tr className="">
                            ...
                            <th style={{minWidth: '380px'}} className="text-center position-relative">
                                ...
                                {/* Requirement for downgrade the plan */}
...
export default AdminClientPricingPlan;