...
import {adminPostCreditHistory} from "../../../../services/AdminService";

const lengths = Utils.tableShowLengths();

function AdminClientCreditHistory() {
    ...
    useEffect(function () {
        ...
        adminPostCreditHistory({client_id: client, limit: limit, page: page})
            .then(response => {
...
export default AdminClientCreditHistory;