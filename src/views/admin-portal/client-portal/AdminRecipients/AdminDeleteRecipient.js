...
import {adminRecipientDelete} from "../../../../services/AdminService";

function AdminDeleteRecipient(props) {
    ...
    const onRecipientDestroy = (e) => {
        e.preventDefault();
        adminRecipientDelete({client_id: client, recipient_id: props.delId})
            .then(response => {
...
export default AdminDeleteRecipient;