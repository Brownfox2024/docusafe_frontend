...
import {adminReadNotificationAlert} from "../../../../services/AdminService";

function ClientPortalNotificationAlert(props) {
    ...
    const handleNotification = (e, data, index) => {
        ...
        adminReadNotificationAlert(obj)
            .then(response => {
                        ...
                        <div className="cur-pointer" onClick={(e) => handleNotification(e, item, index)}>
                            <div className="card-body">
                                ...
                                <div className="progress_bar">
                                    <span
                                        className="progress_count">{parseFloat(item.percentage).toFixed(2)}% Completed</span>
...
export default ClientPortalNotificationAlert;