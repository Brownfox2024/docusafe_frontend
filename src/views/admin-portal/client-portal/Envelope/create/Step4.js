...
import AdminSearchRecipient from "./SearchRecipient";
import {
    DATE_FORMAT_LIST,
    NAME_CONVENTION,
    OVERDUE_REMINDER,
...
import AdminAddEnvelopeTemplate from "../Manage/AddEnvelopeTemplate";
import {Lang} from "../../../../../lang";
import {
    adminEnvelopeFinish,
    adminGetEnvelopeDocumentDetail,
    adminGetEnvelopeRequestFormDetail, 
...
function AdminClientEnvelopeStep4(props) {
    ...
    const onRequestClone = (e, data) => {
        ...
        adminGetEnvelopeRequestFormDetail(obj)
            .then((response) => {
                let formData = {...requestFormData};
                formData.id = 0;
                formData.request_id = response.data.data.request_id;
    ...
    async function onSubmitForm(e, type) {
        ...
        envelopeFormData.client_id = client;
        ...
        adminEnvelopeFinish(envelopeFormData)
            .then((response) => {
                if (type === 1) {
    ...
    function onViewEnvelope(e) {
        ...
        navigate("/back-admin/client-portal/" + client + "/manage/" + envelopeFormData.envelope_uuid);
    }
            ...
            <>
                <div className=" step_wizard_content ">
                    <div className=" container">
                        ...
                        <AdminSearchRecipient formObj={props.formObj} setFormObj={props.setFormObj}/>
...
export default AdminClientEnvelopeStep4;