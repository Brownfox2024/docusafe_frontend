...
import AdminEnvelopeRecipients from "./Recipients";
import {Lang} from "../../../../../lang";
import {adminSearchEnvelopeRecipient, adminUpdateEnvelopeRecipientStep} from "../../../../../services/AdminService";

function AdminClientEnvelopeStep2(props) {
    ...
    function onBack(e) {
        ...
        navigate('/back-admin/client-portal/' + client + '/envelope/edit/' + formData.envelope_uuid + '/1');
    }
    ...
    function onRecipientSearch(e) {
        ...
        if (recipientSearch.trim()) {
            adminSearchEnvelopeRecipient({client_id: client, search: recipientSearch})
                .then((response) => {
    ...
    function onSubmitForm(type) {
        ...
        adminUpdateEnvelopeRecipientStep(obj)
            .then((response) => {
                if (type === 2) {
                    ...
                    props.setFormObj(formData);
                    navigate('/back-admin/client-portal/' + client + '/envelope/edit/' + formData.envelope_uuid + '/3');
                } else {
                    navigate("/back-admin/client-portal/" + client + "/manage/draft");
                }
    ...
    return (
        <>
            <div className=" step_wizard_content ">
                ...
                <AdminEnvelopeRecipients formObj={props.formObj} setFormObj={props.setFormObj}
                                         setLoading={props.setLoading} recipData={docData} setDocData={setDocData}/>
            </div>
...
export default AdminClientEnvelopeStep2;