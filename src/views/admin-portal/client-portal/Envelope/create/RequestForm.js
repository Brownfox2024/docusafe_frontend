...
function AdminEnvelopeRequestForm(props) {
                                        ...
                                        <div className="card my-3 w-100">
                                            ...
                                            {item.type === 3 && (
                                                <>
                                                    ...
                                                    {item.is_show && (
                                                        <textarea 
                                                        placeholder="Please enter each options in a separate line"
                                                        className="form-control mb-1 me-2" rows="5"
...
export default AdminEnvelopeRequestForm;