...
import {adminCreateEnvelope, adminUpdateEnvelope} from "../../../../../services/AdminService";
import DatePicker from "react-datepicker";
import {DATE_FORMAT_LIST} from "../../../../../configs/AppConfig";

function AdminClientEnvelopeStep1(props) {
            ...
            adminCreateEnvelope(obj)
                .then(response => {
                    if (type === 2) {
                        ...
                        formData.client_message = clientMessage;
                        props.setFormObj(formData);
                        navigate('/back-admin/client-portal/' + client + '/envelope/edit/' + response.data.uuid + '/2');
                    } else {
                        navigate('/back-admin/client-portal/' + client);
                    }
                    toast.success(response.data.message);
...
export default AdminClientEnvelopeStep1;