...
import {adminMoveTemplateFolder, adminTemplateFolderList} from "../../../../../services/AdminService";

function AdminMoveFolder(props) {
    ...
    useEffect(function () {
        if (props?.folderData?.id > 0) {
            adminTemplateFolderList({client_id: client, is_all: 0, folder_id: props?.folderData?.id})
                .then(response => {
...
export default AdminMoveFolder;