...
import {adminCopyTemplateEnvelope} from "../../../../../services/AdminService";

function AdminDuplicateTemplate(props) {
    ...
    return (
        <div className="modal fade" id="duplicateTemplateModal" tabIndex="-1"
             aria-labelledby="duplicateTemplateModalLabel" data-bs-backdrop="static" data-bs-keyboard="false"
             aria-hidden="true">
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="duplicateTemplateModalLabel">Duplicate Template</h5>
                    ...
                    <div className="modal-footer justify-content-center">
                        ...
                        <button onClick={handleSubmitCopyEnvelope} type="button" className="btn btn-primary">Duplicate
                        </button>
                    </div>
                </div>
            </div>
...
export default AdminDuplicateTemplate;