...
import {adminRemoveShareTemplateFolder} from "../../../../../services/AdminService";

function AdminRemoveShareFolder(props) {
    ...
    const handleRemoveShareFolder = (e) => {
        ...
        adminRemoveShareTemplateFolder(obj)
            .then(response => {
...
export default AdminRemoveShareFolder;