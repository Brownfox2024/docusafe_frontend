...
import {adminDeleteEnvelopeTemplate} from "../../../../../services/AdminService";

function AdminDeleteTemplateEnvelope(props) {
    ...
    const handleDeleteTemplateEnvelope = (e) => {
        ...
        adminDeleteEnvelopeTemplate(obj)
            .then(response => {
...
export default AdminDeleteTemplateEnvelope;