...
import {adminGetEnvelopeSenderList, adminGetManageEnvelopeList} from "../../../../../services/AdminService";

const lengths = Utils.tableShowLengths();

function AdminDraftManageEnvelope() {
    ...
    const onEditEnvelope = (e, data) => {
        e.preventDefault();
        navigate('/back-admin/client-portal/' + client + '/envelope/edit/' + data.uuid + '/' + data.current_step);
    };
...
export default AdminDraftManageEnvelope;