...
import {adminManageEnvelopeSetting} from "../../../../../../services/AdminService";
import DatePicker from "react-datepicker";
import {default as ReactSelect} from "react-select";
import {components} from "react-select";

function AdminEnvSetting(props) {
    ...
    const handleEnvSettingForm = (e) => {
        ...
        adminManageEnvelopeSetting(obj)
            .then(response => {
...
export default AdminEnvSetting;