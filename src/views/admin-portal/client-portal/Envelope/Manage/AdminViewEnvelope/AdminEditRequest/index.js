...
import AdminRequestDocFormTemplate from "./AdminRequestDocFormTemplate";
import {toast} from "react-toastify";
import Utils from "../../../../../../../utils";
import AdminManageDocument from "./AdminManageDocument";
import AdminManageForm from "./AdminManageForm";
import {Lang} from "../../../../../../../lang";
import {
    adminEditRequestUpdateDocumentForm,
    adminGetEnvelopeDocumentDetail,
    adminGetEnvelopeRequestInformationDetail,
    adminRemoveEnvelopeDocument, adminRemoveEnvelopeRequestForm
} from "../../../../../../../services/AdminService";

function AdminEditRequest(props) {
    ...
    const handleEditSave = async (e) => {
        ...
        adminEditRequestUpdateDocumentForm(obj)
            .then(response => {
                toast.success(response.data.message);
                props.setLoading(false);
                props.setIsEditRequest(false);
    ...
    return (
        <div className={`tab-content p-5`}>
                        ...
                        <div className="d-flex flex_wrap">
                            {props?.isTemplate === true && (
                                <button type="button" className="btn shadow load_template_btn me-2"
                                        ...
                                        onClick={(e) => handleUseDocFormTemplate(e, 2)}>Add From Templates
                                </button>
                            )}
                            <button type="button" className="btn shadow add_recipients_btn" data-bs-toggle="offcanvas"
            ...
            <AdminManageDocument documentList={documentList} setDocumentList={setDocumentList}
                                 setLoading={props.setLoading} envelopeId={envelopeId} docData={docData}
                                 setDocData={setDocData} recipientsList={recipientsList}/>

            <AdminManageForm formList={formList} setFormList={setFormList} setLoading={props.setLoading}
                             envelopeId={envelopeId} requestFormData={requestFormData}
                             setRequestFormData={setRequestFormData} recipientsList={recipientsList}/>

            <AdminRequestDocFormTemplate fromTemplate={fromTemplate} setFromTemplate={setFromTemplate}
                                         envelopeId={envelopeId} documentList={documentList}
                                         setDocumentList={setDocumentList} formList={formList} setFormList={setFormList}
                                         isUseFromTemplate={isUseFromTemplate}
                                         setIsUseFromTemplate={setIsUseFromTemplate}/>
        </div>
    );
}
