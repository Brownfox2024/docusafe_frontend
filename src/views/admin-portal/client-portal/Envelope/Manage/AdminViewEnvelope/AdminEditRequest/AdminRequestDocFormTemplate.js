...
function AdminRequestDocFormTemplate(props) {
    ...
    }, [props, client, currentTemplate, selectedTemplateList]);
            ...
            if (docIds.length > 0 || dataIds.length > 0) {
                ...
                adminPostUseTemplateDocumentData(obj)
                    .then(response => {
                        ...
                        props.setDocumentList([...docList, ...response.data.docList]);
                        let fList = [...props.formList];
                        props.setFormList([...fList, ...response.data.dataList]);
...
export default AdminRequestDocFormTemplate;