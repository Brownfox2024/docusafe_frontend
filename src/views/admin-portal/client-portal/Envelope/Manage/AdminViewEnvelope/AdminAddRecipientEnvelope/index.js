...
import AdminSearchRecipient from "./AdminSearchRecipient";
import AdminAddRecipient from "./AdminAddRecipient";
import {toast} from "react-toastify";
import Utils from "../../../../../../../utils";
import {Lang} from "../../../../../../../lang";
import {
    adminAddRecipientViewEnvelope,
    adminGetEnvelopeDataInAddRecipient
} from "../../../../../../../services/AdminService";

function AdminAddRecipientEnvelope() {
    ...
    useEffect(function () {
        setLoading(true);
        adminGetEnvelopeDataInAddRecipient({client_id: client, id: id})
            .then(response => {
            ...
            .catch(err => {
                setLoading(false);
                navigate("/back-admin/client-portal/" + client + "/manage/" + id);
            });
    ...
    const handleSendInvite = async (e) => {
        ...
        adminAddRecipientViewEnvelope(obj)
            .then(response => {
                setLoading(false);
                navigate("/back-admin/client-portal/" + client + "/manage/" + id);
        ...
        <>
            ...
            <section className="main_wrapper background_grey_400" style={{minHeight: 'calc(100vh - 119px)'}}>
                <h2 className="main_title mb-4 d-flex align-items-center py-3 px-5 border-bottom bread_crumb flexWrap">
                    ...
                    <NavLink to={"/back-admin/client-portal/" + client + "/manage/" + id}
                             className="text_blue">{envelopeName}</NavLink>
                    <i className="fa fa-angle-double-right mx-3"/>
                    Add Recipients
                </h2>
                <div className="step_wizard_content">
                    ...
                    <AdminAddRecipient docList={documentList} formList={formList} recipientList={recipientList}
                                       setRecipientList={setRecipientList} recipientData={recipientData}
                                       setRecipientData={setRecipientData} setLoading={setLoading}
                                       envelopeId={envelopeId}/>

                    <AdminSearchRecipient docList={documentList} formList={formList} recipientList={recipientList}
...
export default AdminAddRecipientEnvelope;